# 如果面试官深挖 Agent Eval：Tool、State 与 Task Success 的生产落地和排障，你怎么回答？
...
### 追问 1：Agent Eval：Tool、State 与 Task Success 的核心机制是什么？
...
### 延伸追问 1：Agent Eval：Tool、State 与 Task Success 的核心机制是什么？
