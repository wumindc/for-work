# 如果面试官深挖 MyBatis SqlSession、Mapper 代理与 Spring 集成 的生产落地和排障，你怎么回答？
...
### 追问 1：MyBatis SqlSession、Mapper 代理与 Spring 集成 的核心机制是什么？
...
### 延伸追问 1：MyBatis SqlSession、Mapper 代理与 Spring 集成 的核心机制是什么？
