# 如果面试官深挖 Cross-encoder、LLM Judge 与两阶段 Rerank 的生产落地和排障，你怎么回答？
...
### 追问 1：Cross-encoder、LLM Judge 与两阶段 Rerank 的核心机制是什么？
...
### 延伸追问 1：Cross-encoder、LLM Judge 与两阶段 Rerank 的核心机制是什么？
