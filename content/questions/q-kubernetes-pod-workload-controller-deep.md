# 如果面试官深挖 Kubernetes Pod、Deployment 与工作负载控制器 的生产落地和排障，你怎么回答？
...
### 追问 1：Kubernetes Pod、Deployment 与工作负载控制器 的核心机制是什么？
...
### 延伸追问 1：Kubernetes Pod、Deployment 与工作负载控制器 的核心机制是什么？
