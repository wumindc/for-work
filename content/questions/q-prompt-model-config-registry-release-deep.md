# 如果面试官深挖 Prompt、Model、Config Registry 与灰度发布 的生产落地和排障，你怎么回答？
...
### 追问 1：Prompt、Model、Config Registry 与灰度发布 的核心机制是什么？
...
### 延伸追问 1：Prompt、Model、Config Registry 与灰度发布 的核心机制是什么？
