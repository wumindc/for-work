# 如果面试官深挖 Eval Fixture、Grader、Rubric 与 Threshold 的生产落地和排障，你怎么回答？
...
### 追问 1：Eval Fixture、Grader、Rubric 与 Threshold 的核心机制是什么？
...
### 延伸追问 1：Eval Fixture、Grader、Rubric 与 Threshold 的核心机制是什么？
