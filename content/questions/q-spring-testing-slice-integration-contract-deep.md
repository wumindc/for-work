# 如果面试官深挖 Spring 测试切片、集成测试与契约回归 的生产落地和排障，你怎么回答？

## 面试定位

这道题关联 Spring 测试切片、集成测试与契约回归，难度 4/5，出现频率 medium。面试官真正想看的是：你能否把概念回答升级成架构、数据流、指标、取舍和真实故障处理。
...
### 追问 1：Spring 测试切片、集成测试与契约回归 的核心机制是什么？
...
### 延伸追问 1：Spring 测试切片、集成测试与契约回归 的核心机制是什么？
