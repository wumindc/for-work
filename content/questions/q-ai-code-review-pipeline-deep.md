# 如何让 AI Review 评论既能发现真实问题，又不变成噪声？

## 面试定位

这道题关联 AI Code Review Pipeline，难度 5/5，出现频率 high。面试官真正想看的是：你能否把概念回答升级成架构、数据流、指标、取舍和真实故障处理。
...
### 延伸追问 1：AI Code Review 系统应该如何设计？
