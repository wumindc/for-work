# 如何防止自动生成的 Wiki 把错误知识固化下来？

## 面试定位

这道题关联 自生长知识库与企业 Wiki，难度 5/5，出现频率 medium。面试官真正想看的是：你能否把概念回答升级成架构、数据流、指标、取舍和真实故障处理。
