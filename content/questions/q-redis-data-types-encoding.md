...
- [Redis Documentation](https://redis.io/docs/latest/)：用于确认 Redis 数据结构、命令模型和运行时边界。
- [Redis Data Types](https://redis.io/docs/latest/develop/data-types/)：用于支持 String、Hash、List、Set、ZSet、Stream 等类型选择和使用场景。
- [Redis Commands](https://redis.io/docs/latest/commands/)：用于核对命令复杂度、参数语义和排障时的命令行为。
