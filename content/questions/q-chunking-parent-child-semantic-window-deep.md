# 如果面试官深挖 Semantic、Parent-child 与 Sentence-window Chunk 策略 的生产落地和排障，你怎么回答？
...
### 追问 1：Semantic、Parent-child 与 Sentence-window Chunk 策略 的核心机制是什么？
...
### 延伸追问 1：Semantic、Parent-child 与 Sentence-window Chunk 策略 的核心机制是什么？
