# 如何把抽象审美要求变成 Agent 可执行、可验证的前端约束？

## 面试定位

这道题关联 DESIGN.md 与 AI 可读设计资产，难度 4/5，出现频率 medium。面试官真正想看的是：你能否把概念回答升级成架构、数据流、指标、取舍和真实故障处理。
...
### 追问 1：为什么 AI 编程需要 DESIGN.md 这类设计资产？
...
### 延伸追问 1：为什么 AI 编程需要 DESIGN.md 这类设计资产？
