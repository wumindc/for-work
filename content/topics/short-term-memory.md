...
- [LangGraph](https://github.com/langchain-ai/langgraph)：用于理解状态驱动的多步 Agent 和 checkpoint。
- [Anthropic: Building effective agents](https://www.anthropic.com/engineering/building-effective-agents)：用于理解何时需要更复杂的 Agent loop。
- [AgentGuide: 2026 Agent 求职通关路线](https://github.com/adongwanai/AgentGuide/blob/main/docs/05-roadmaps/agent-job-ready-roadmap-2026.md)：用于面试复习中的 State、Memory、Context 组织。
