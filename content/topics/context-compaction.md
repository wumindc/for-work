...
- [OpenAI Agents SDK Tracing](https://openai.github.io/openai-agents-python/tracing/)：参考 agent run 的结构化事件记录。
- [LangGraph Persistence](https://docs.langchain.com/oss/python/langgraph/persistence)：参考 checkpoint 和 thread-scoped state。
- [SWE-bench](https://www.swebench.com/)：理解长上下文代码任务的真实复杂度。
