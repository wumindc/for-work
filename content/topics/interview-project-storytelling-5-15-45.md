# AI 项目讲述：5 分钟、15 分钟与 45 分钟版本

## 面试定位

AI 项目讲述：5 分钟、15 分钟与 45 分钟版本 属于 AI 求职作品集与项目表达 / 项目讲述 5/15/45 分钟版本。面试里它不是背概念题，而是用来判断你是否能把知识落到架构、数据流、指标和取舍上。
一句话定位：同一个 AI 项目要准备电梯版、深挖版和系统设计版，分别覆盖目标、架构、数据、评测、失败和取舍。
...
- story arc、depth levels、interview follow-up map and evidence switching 要服务生产问题
- 5/15/45 minute story script、follow-up map 必须可版本化和可复盘
- 短讲说不清价值，深挖接不住技术细节 要有门禁和降级
...
图 1：AI 项目讲述：5 分钟、15 分钟与 45 分钟版本 的回答要从业务入口进入，先讲边界和数据结构，再讲机制、失败模式、指标和取舍。

## 系统设计案例

### AI 项目讲述：5 分钟、15 分钟与 45 分钟版本 的面试级设计题
...
同一个 AI 项目要准备电梯版、深挖版和系统设计版，分别覆盖目标、架构、数据、评测、失败和取舍。 AI 项目讲述：5 分钟、15 分钟与 45 分钟版本 是 AI 工程生产化能力的一部分，关注 story arc、depth levels、interview follow-up map and evidence switching。 5/15/45 minute story script、follow-up map 是团队复盘、验收和面试表达的核心证据。 短讲说不清价值，深挖接不住技术细节 是这个主题最容易被追问的生产风险。 生产 AI 系统要先定义可验证边界，再谈模型效果。 所有关键配置、数据、prompt、模型、工具和评测结果都要可追溯。 质量、延迟、成本、安全和用户体验要一起权衡，不能只优化单一指标。 失败样本要进入回归集，避免同类问题重复发生。
