...
- [OpenAI: A practical guide to building agents](https://cdn.openai.com/business-guides-and-resources/a-practical-guide-to-building-agents.pdf)：用于 Agent 编排、工具和 guardrails 的工程边界。
- [LangGraph](https://github.com/langchain-ai/langgraph)：用于理解状态图、checkpoint 与长任务状态恢复的工程模型。
- [Anthropic: Building effective agents](https://www.anthropic.com/engineering/building-effective-agents)：用于 workflow 与 agent 边界，以及复杂度递增的设计原则。
